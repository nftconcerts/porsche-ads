      ...
      <div className="flex flex-col items-center justify-start min-h-full py-10 px-4">
        ...
        <div className="w-11/12 lg:w-3/4 max-w-4xl">
          ...
          <p className="mb-4">
            ...
            layout, screen interfaces, &quot;look and feel&quot;, logo or
            graphic images appearing herein, and the operation of this Site
            (collectively, &quot;Materials&quot;), which are protected by
            ...
            Nothing in these TOU transfers any rights in the Materials to you or
            any third party and you acknowledge and agree that you do not
            acquire any ownership rights by downloading or viewing any
            Materials. Porsche® and related trademarks are the property of Dr.
            Ing. h.c. F. Porsche AG. This site is not affiliated with or
            endorsed by Porsche AG.
          </p>
          <h4 className="font-bold text-xl mb-4 text-white">Use Limitation</h4>
          <h5 className="font-bold italic mb-4">
          ...
          <h4 className="font-bold text-xl mb-4 text-white">Linking</h4>
          <p className="mb-4">
            A link to a linked website (&quot;Linked Site&quot;) on this Site
            does not mean that COMPANY endorses or accepts any responsibility
            for the content, functioning or use of such Linked Site, and you
            enter any such website at your own risk. You agree that COMPANY has
            no control over or liability for information on Linked Sites. You
            should be aware that Linked Sites may contain rules and regulations,
            privacy provisions, confidentiality provisions, and other provisions
            that are different from the provisions provided on this Site.
            COMPANY is not responsible for such provisions, and expressly
            disclaims any and all liability related to such provisions. COMPANY
            prohibits unauthorized hypertext links to this Site, or the framing
            of this Site.
          </p>
          ...
          <p className="mb-4">
            ...
            COMPANY assumes no responsibility regarding any data or payment
            information that is intercepted or accessed by third parties during
            any of your interactions with the Site. THE SITE AND ALL OTHER
            ...
            THIS SITE, ARE PROVIDED &quot;AS IS,&quot; &quot;WHERE IS,&quot; AND
            &quot;AS AVAILABLE,&quot; BY COMPANY, AS A CONVENIENCE TO ALL USERS
          ...
          <p className="mb-4">
            ...
            VIRUSES THAT MAY INFECT A USER&#39;S EQUIPMENT, FAILURE OF
            MECHANICAL OR ELECTRONIC EQUIPMENT OR COMMUNICATION LINES, TELEPHONE
            OR OTHER INTERCONNECT PROBLEMS, UNAUTHORIZED ACCESS, THEFT, OPERATOR
            ERRORS, STRIKES OR OTHER LABOR PROBLEMS OR ANY FORCE MAJEURE EVENT.
            IN JURISDICTIONS THAT PROHIBIT THE EXCLUSION OR LIMITATION OF
            LIABILITY FOR CONSEQUENTIAL OR INCIDENTAL DAMAGES, COMPANY&apos;S
            LIABILITY IS LIMITED TO THE GREATEST EXTENT PERMITTED BY THE LAW.{" "}
          </p>
          <h4 className="font-bold text-xl mb-4 text-white">Termination </h4>
          <p className="mb-4">
          ...
          <h4 className="font-bold text-xl mb-4 text-white">Feedback</h4>
          <p className="mb-4">
            {" "}
            To the extent permitted by applicable law, any comments or materials
            (&quot;Feedback&quot;) sent to COMPANY including questions,
            suggestions, ideas, comments, or the like relating to this Site
            shall be deemed to be non-confidential and shall become the property
            of COMPANY upon receipt. COMPANY shall have no obligation of any
            kind with respect to such Feedback and shall be free to transmit,
            reproduce, use, exhibit, disclose, display, transform, copyright,
            create derivative works, and distribute the Feedback to others
            without limitation. Further, COMPANY shall be free to use any ideas,
            concepts, know-how and techniques contained in such Feedback for any
          ...
          <p className="mb-4">
            The Site provides access to create custom Porsche-style
            advertisements by uploading your own images. All images uploaded by
            the user must be original or properly licensed for your use. To
            purchase and export images, you will need to set up a user profile
            on the Site. User profiles require a unique email and password that
            you select or you can use one of our provided login providers
            (Google). You are responsible for all use of your email and password
            and COMPANY is entitled to follow any instructions received through
            an access session with your email and password. User profiles on the
            Site will be associated with your email.
          </p>{" "}
          <p className="mb-4">
            All images that you upload for use in creating advertisements must
            be original and owned by you or properly licensed, and you represent
            and warrant that you have full and unrestricted rights to such
            images. By uploading images, you are granting COMPANY a limited
            license to process and display your images for the sole purpose of
            creating your custom advertisements. COMPANY will not use your
            uploaded images for any other purpose without your explicit consent.
            When uploading your images to our platform, you assume all liability
            concerning any later claims brought by any party concerning image
            ownership or usage rights.
          </p>
          <p className="mb-4">
            While COMPANY will take commercially reasonable steps to protect
            your images and data, please understand that no system is completely
            secure. COMPANY will not be responsible for third party actions
            concerning unauthorized use/display of any images or content that
            you create, generate, or upload.
          </p>
          <p className="mb-4">
            ...
            attorney&apos;s fees and court costs) arising out of and/or related
            to any breach of these TOU.
          </p>
          <h4 className="font-bold text-xl mb-4 text-white">
            Payment and Subscriptions
          </h4>
          <p className="mb-4">
            The Site offers two purchase options: (1) a one-time purchase of a
            3-pack of image exports, and (2) a monthly subscription for
            unlimited exports. All payments are processed through Stripe. By
            making a purchase, you agree to provide accurate and complete
            payment information. Subscription services will automatically renew
            monthly unless cancelled. You may cancel your subscription at any
            time through your account settings. Refunds are handled on a
            case-by-case basis at COMPANY&apos;s discretion. COMPANY reserves
            the right to modify pricing at any time, though existing
            subscriptions will maintain their current pricing until cancelled or
