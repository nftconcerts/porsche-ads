...
const GALLERY_IMAGES = [
  ...
  {
    id: 4,
    src: "/examples/example-4.jpg",
    alt: "Porsche Taycan Ad",
  },
  {
    id: 5,
    src: "/examples/example-5.jpg",
    alt: "Porsche Cayman Ad",
  },
  {
    id: 6,
    src: "/examples/example-6.jpg",
    alt: "Porsche Boxster Ad",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Example Porsche ads created with our builder
          </p>
        </div>
